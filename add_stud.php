			...
			<div class="col-md-9">
				...
				<div class="row">
					<div class="col-6 fix">
						...
						<form enctype="multipart/form-data" role="form" onsubmit ="return validate()" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
							<br>
							...
							<br>
							 ...
							 <input type="text" name="pho" pattern="[1-9]{1}[0-9]{9}"placeholder="Phone No" required class="input form-control"><br>
					...
					<div class="col-6 text-center rboxl">
						...
						<?php
						 ...
						 ?>
						 <br>
						 <input type="text" name="email" id="emil" placeholder="Parent's Email" required class="input form-control"><br>
