				...
				<div class="row">
					<div class="col-5 fix">
						...
						<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
							<br>
							<input type="number" name="cname" placeholder="Class No" required class="input form-control"> <br>

							<input type="text" name="sec" placeholder="Select your Section " required class="input form-control"> <br>
