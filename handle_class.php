					...
					<div class="col-4 fix">
						...
						<form enctype="multipart/form-data" role="form" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
							...
							if($re->num_rows>0){
							 ...
							 <input type="time" name="stime" placeholder="Start Time " required class="input form-control"><br>
							 <label style="color:white" >End time</label>
							<input type="time" name="etime" placeholder=" End Time" required class="input form-control"><br>
